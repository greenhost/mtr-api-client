 ...
 */
#[ExclusionPolicy('all')]
class DomainTransferRejectRequest extends AbstractRequest
{
    /**
     * @var string
     */
    protected $url ='domain/transfer/{name}/reject';
     ...
     */
    public function setName(string $name): DomainTransferRejectRequest
    {
        $this->name = $name;
        return $this;
    }
