...
use Metaregistrar\Api\Client\Response\HostDeleteResponse;
...
class HostDeleteRequest extends AbstractRequest
{
     ...
     * @var string
     */
    protected $expectedResponse = HostDeleteResponse::class;
     ...
     */
    public function setName(string $name): HostDeleteRequest
    {
        $this->name = $name;
        return $this;
    }
     ...
     */
    public function setHostname(string $hostname): HostDeleteRequest
    {
